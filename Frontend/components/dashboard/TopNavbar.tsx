          ...
          <div className="relative max-w-sm flex-1 transition-all duration-base ease-standard focus-within:max-w-md" ref={searchRef}>
            <div className="relative flex items-center">
              <input
                ...
                className="h-10 w-full rounded-xl border border-slate-200/80 bg-slate-100/90 pl-4 pr-10 text-sm font-medium text-slate-900 outline-none transition-all placeholder:text-slate-500 hover:bg-slate-200/80 hover:border-slate-300 focus:bg-white focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-[#161C44] dark:bg-[#0A0C1E] dark:text-[#F0F1F4] dark:placeholder-[#6D7792] dark:hover:bg-[#161C44] dark:focus:bg-[#0E122E] dark:focus:border-primary dark:focus:ring-primary/30"
              />
        ...
        <div className="flex items-center gap-3">
          ...
          {currentRole === 'Hiring Manager' ? (
            <button
              onClick={toggleTheme}
              type="button"
              className="p-2 rounded-xl bg-slate-100 dark:bg-surface border border-slate-200 dark:border-border text-slate-700 dark:text-text-primary hover:bg-slate-200 dark:hover:bg-surface-hover transition flex items-center gap-1.5 text-xs font-semibold"
              title="Toggle Theme"
            >
              {isDark ? (
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden items-center gap-2 sm:flex">
                ...
                <ChevronDown
                  className={`h-4 w-4 text-muted transition-transform dark:text-muted ${showProfileMenu ? 'rotate-180' : ''
                    }`}
                />
              </div>
            </button>
