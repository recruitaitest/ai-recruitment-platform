    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-lg font-semibold text-text-primary">CV Ingestion & Application Analytics</h3>
            <p className="text-xs text-secondary">Real-time daily CV reception & position distribution metrics</p>
          </div>
        </div>
      </div>
