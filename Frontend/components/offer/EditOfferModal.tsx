    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      >
        <div className="flex shrink-0 items-center justify-between border-b border-slate-100 dark:border-border px-6 py-5">
          <div>
            <h2 className="text-xl font-bold text-slate-900 dark:text-text-primary">Edit Offer</h2>
            <p className="mt-1 text-sm text-slate-500 dark:text-muted">Update candidate offer details</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="space-y-6 overflow-y-auto p-6 flex-1">
          {loading ? (
            <div className="text-slate-500 dark:text-muted">Loading offer details...</div>
          ) : offer ? (
            ...
            <div className="text-slate-500 dark:text-muted">Offer not found.</div>
          )}
        </div>
